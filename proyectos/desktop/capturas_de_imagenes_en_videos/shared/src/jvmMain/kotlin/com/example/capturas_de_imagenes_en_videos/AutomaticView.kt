...
@Composable
fun AutomaticView(navController: NavController) {
    ...
    MaterialTheme {
        ...
        Scaffold { paddingValues ->
            ...
            Column(
                ...
                Button(
                    enabled = videoPath.isNotEmpty() && !isGenerating,
                        ...
                        scope.launch {
                            ...
                            try {
                                ...
                                val images = withContext(Dispatchers.IO) {
                                    ...
                                    ffmpegService.extractFramesAutomatically(
                                        videoPath = videoPath
                                    )
                                }
